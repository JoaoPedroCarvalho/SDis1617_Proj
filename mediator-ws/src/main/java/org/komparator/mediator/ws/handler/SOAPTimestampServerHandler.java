...
public class SOAPTimestampServerHandler implements SOAPHandler<SOAPMessageContext> {
    ...
    public static final String CLASS_NAME = SOAPTimestampServerHandler.class.getSimpleName();
